...
interviewer's question plus your uploaded CV / job description to Claude
...
- Streaming Claude Sonnet 4.6 / Opus 4.6 answers (via OpenRouter)
...
- Auth via shared OTP module (`/opt/apps/shared-auth`)
